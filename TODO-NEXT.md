...
- [x] Docker Compose (app + postgres) on VPS 3.0.92.255:8000
...
6. [x] Caddy reverse proxy (80/443) + AWS SG ports opened — http://3.0.92.255 works
...
- External access to 3.0.92.255:8000 from local machine hangs (port/SG likely closed).
...
- External access to 3.0.92.255:8000 still hangs (port/SG closed).
